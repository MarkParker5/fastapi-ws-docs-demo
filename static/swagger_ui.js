        ...
        selectors: {
          socketUrl: (state) => {
            ...
            paths.forEach((path, pathName) => {
              // if (_isWs(pathName)) {
              //   console.log("[WS DOCS] Detected WebSocket path:", pathName);
              // }
          ...
          socketOperations: (state) => {
            ...
            paths.forEach((path, pathName) => {
              ...
              path.forEach((operation, method) => {
                // TODO:
                // if (["send", "receive"].indexOf(method) < 0 || (_isWs(pathName) && ["post", "get"].indexOf(method) < 0)) {
                //   return;
                // }
                operations.push({
                  path: pathName,
    ...
    components: {
      WsResponse: ({ event, response, getConfigs }) => {
        ...
        if (!response || typeof response.getIn !== "function") {
          console.error("[WS DOCS] WsResponse: response is not an Immutable object", response);
          return React.createElement("tr", {}, React.createElement("td", {}, "Error: response not available"));
        }

        const activeMediaType = response.getIn(["content", "application/json"]);

        // Defensive check for activeMediaType and get
        if (!activeMediaType || typeof activeMediaType.get !== "function") {
          console.error("[WS DOCS] WsResponse: activeMediaType is not an Immutable object", activeMediaType);
          return React.createElement("tr", {}, React.createElement("td", {}, "Error: activeMediaType not available"));
        }
        ...
        return React.createElement(
          ...
          React.createElement(
            "td",
            { class: "response-col_body", style: { width: "85%" } },
      ...
      WsResponses: (props) => {
        ...
        const rows = responses.entrySeq().map(([event, response]) =>
          React.createElement(wsResponse, {
            event,
            response,
            getConfigs,
          }),
        ...
        return React.createElement(
          ...
          React.createElement("div", { class: "opblock-section-header" }, React.createElement("h4", {}, "Receiving data")),
      ...
      SocketConnection({ url, socketSelectors, socketActions, ...props }) {
        ...
        const toggle = React.createElement("button", { class: "opblock-control-arrow", tabIndex: -1, onClick: toggleShown }, isShown ? "▼" : "▲");
        ...
        const socketMessagesComponent = React.createElement(
          "span",
          {},
          React.createElement(
            "div",
            ...
            React.createElement(
              "div",
              { class: "opblock-summary opblock-summary-get" },
              React.createElement(
                "button",
                { class: "opblock-summary-control", onClick: toggleShown },
                React.createElement(
                  "span",
                  {
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                { class: "operation-tag-content" },
                isShown ? React.createElement("div", { class: "responses-inner" }, React.createElement("div", { class: "opblock-body" }, table)) : null,
              ),
            ),
          ),
        );

        return React.createElement("div", {}, React.createElement("style", {}, "td.ws-message-response h5 { display: none }"), socketMessagesComponent);
      },
    },
    wrapComponents: {
      curl:
      ...
      operations:
        ...
        (props) => {
          ...
          urls.forEach((url) =>
            socketComponents.push(
              React.createElement(WsConnection, {
                url,
                ...props,
              }),
            ),
          ...
          return React.createElement("div", null, React.createElement(Original, props), ...socketComponents);
        },
      OperationSummary:
        (Original, { React }) =>
        (props) => {
...
ui.initOAuth({
  ...
  realm: "demo-realm",
  appName: "FastAPI WebSocket Demo",
  scopeSeparator: " ",
